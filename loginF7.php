...
<title>Zanist - Sulemaniya Login</title>
 ...
 if(isset($_POST ['log']))
{
	...
	$query = mysql_query("SELECT * FROM `passf7` WHERE `username` = '$user' and `password` = '$pass'");
