...
<form action="levelSearch1.php" method="post">
 <center>
...
<font size="+1"><b> Select the Level:</b></font>
  ...
  <div style="position: absolute; width: 1101px; left: 2px; top: 177px; height: 951px;">
 ...
 require 'connect1.php';
		...
		$query1 = "SELECT `recNo`, `date`, `details`, `level`, SUM(`amount`) AS amount, `status`, `telNo.`, `notes` FROM `bryarrevenue`  WHERE `level` = '$lvl' || `status` = '$status' GROUP BY `details` ORDER BY `recNo`";
