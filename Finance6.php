...
<div style="position: absolute; left: 469px; top: 31px;" class="switch">
  <div class="logo">Zanist - Erbil School</div></span></div>		
<nav>
<div style="position: absolute; top: 58px; height: 151px; left: 512px;"> <img src="images/zanstErbilLogo.gif" </div>
<br />
<div style="position: absolute; left: 31px; top: 199px; width: 219px;">
<a href="main6.php">Home</a>
<a href="logout6.php">Logout</a>
</div>
 </nav>	
</div>


<div class="index-box" style="position: absolute; left: 199px; top: 278px; width: 888px;">
<a href="RevenueTransaction6.php" class="sub-box">Record a<br>
Revenue</a>
<a href="ExpensesTransaction6.php" class="sub-box">Record an<br>Expenses</a>
<a href="cashFlow6.php" class="sub-box">Cash <br />Flow</a>
<a href="#" class="sub-box">Manage<br>Invoices</a>
...
<script src="./Main Overview_files/saved_resource" type="text/javascript"></script><link href="./Main Overview_files/ui+en_GB.css" type="text/css" rel="stylesheet"><script src="./Main Overview_files/format+en_GB,default+en_GB,ui+en_GB,corechart+en_GB.I.js.download" type="text/javascript"></script>
