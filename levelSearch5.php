...
<form action="levelSearch5.php" method="post">
 <center>
...
<font size="+1"><b> Select the Level:</b></font>
 ...
 require 'connect1.php';
		...
		$query1 = "SELECT `recNo`, `date`, `details`, `level`, SUM(`amount`) AS amount, `status`, `telNo.`, `notes` FROM `inistrevenue` WHERE `level` = '$lvl' && `status` = '$status' GROUP BY `details` ORDER BY `recNo`";
