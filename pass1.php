...
<div class="index-box">
			<h2> Financial Affairs Login / Bryar School</h2>
...
<p><button type="submit" class="button" name="log">Click to Login</button></p>
</form>
<br>
</div>
		<div class="clear"></div>
 ...
 if(isset($_POST ['log']))
{
	...
	$query = mysql_query("SELECT * FROM `bryarlogin` WHERE `username` = '$user' and `password` = '$pass'");
	...
	echo "<script>location.assign('Finance1.php')</script>";
