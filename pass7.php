...
<div class="index-box">
			<h2> Financial Affairs Login / Zanist Sulemaniya School</h2>
 ...
 if(isset($_POST ['log']))
{
	...
	$query = mysql_query("SELECT * FROM `zanistslogin` WHERE `username` = '$user' and `password` = '$pass'");
	...
	echo "<script>location.assign('Finance7.php')</script>";
