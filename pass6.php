...
<div class="index-box">
			<h2> Financial Affairs Login / Zanist erbil School</h2>
 ...
 if(isset($_POST ['log']))
{
	...
	$query = mysql_query("SELECT * FROM `zanistelogin` WHERE `username` = '$user' and `password` = '$pass'");
	...
	echo "<script>location.assign('Finance6.php')</script>";
