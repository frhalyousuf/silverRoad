...
<title>Financial Affairs Login</title>
...
<div class="index-box">
			<h2> Financial Affairs Login / Hawler - Twana Inistitute</h2>
...
<p><button type="submit" class="button">Click to Login</button></p>
</form>
<br>
</div>
		<div class="clear"></div>
 ...
 if(isset($_POST ['log']))
{
	...
	$query = mysql_query("SELECT * FROM `inistitutelogin` WHERE `username` = '$user' and `password` = '$pass'");
	...
	echo "<script>location.assign('Finance5.php')</script>";
