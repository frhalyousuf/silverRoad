...
<div class="index-box">
			<h2> Financial Affairs Login / Ban School</h2>
 ...
 if(isset($_POST ['log']))
{
	...
	$query = mysql_query("SELECT * FROM `banlogin` WHERE `username` = '$user' and `password` = '$pass'");
	...
	echo "<script>location.assign('Finance4.php')</script>";
