...
<form action="levelSearch7.php" method="post">
 <center>
...
<font size="+1"><b> Select the Level:</b></font>
 ...
 require 'connect1.php';
		...
		$query1 = "SELECT `recNo`, `date`, `details`, `level`, SUM(`amount`) AS amount, `status`, `telNo.`, `notes` FROM `zanistsrevenue` WHERE `level` = '$lvl' GROUP BY `details` ORDER BY `recNo`";
