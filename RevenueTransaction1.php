...
if(isset($_POST ["add"]))
{
	...
	$query = "INSERT INTO `bryarRevenue`(`recNo`, `date`, `details`, `level`, `amount`,`status`, `telNo.`, `notes` ) VALUES ('$no', '$date', '$details', '$level', '$amount','$status', '$mobNo', '$notes')";
	
	$result=mysql_query($query)  or die(mysql_error());
	
	if($result)
		{
			echo "<meta http-equiv='refresh' content='0; url=RevenueTransaction1.php'>";
...
<br>
<form action="RevenueTransaction1.php" method="post">
<label>Receipt No.:</label>
<input readonly type="text" name="recNo" style="width:150px" value="<?php  
require("connect1.php");
$q=  mysql_query("SELECT MAX(`recNo`) as maximum FROM `bryarrevenue` ");
{
...
<label>Level:<font color="red" size="+2"> * </font> </label><select name="lvl2" id="lvl2" style="width:150px">
  ...
  <div style="position: absolute; left: 463px; top: 353px;"> <label>Status:</label>
</div>
<div style="position: absolute; left: 527px; top: 348px; width: 125px;"> <select name="status" id="status" style="width:100px">
  ...
  </div> <div style="position: absolute; left: 650px; top: 360px;">   <a href="levelSearch1.php"> Search </a> </div>
...
<br>
 ...
 require("connect1.php");
$query1= "SELECT * FROM `bryarrevenue` ORDER BY `recNo` ASC ";
