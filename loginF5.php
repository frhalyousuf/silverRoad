...
<div class="index-box">
			<h2> Login to finance department / Hawler - twana Inistitute</h2>
            <p>Enter your login details in the boxes below, then click the 'Click to Login' button.</p><br>
<form action="loginF5.php" method="post">
 ...
 if(isset($_POST ['log']))
{
	...
	$query = mysql_query("SELECT * FROM `passf5` WHERE `username` = '$user' and `password` = '$pass'");
