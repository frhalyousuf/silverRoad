...
<div class="index-box">
			<h2> Financial Affairs Login / Lana School</h2>
 ...
 if(isset($_POST ['log']))
{
	...
	$query = mysql_query("SELECT * FROM `lanalogin` WHERE `username` = '$user' and `password` = '$pass'");
	...
	echo "<script>location.assign('Finance2.php')</script>";
