...
<title>Zanist - Erbil Login</title>
 ...
 if(isset($_POST ['log']))
{
	...
	$query = mysql_query("SELECT * FROM `passf6` WHERE `username` = '$user' and `password` = '$pass'");
